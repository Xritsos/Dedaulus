...
def DaedalusInterpolator(directory,model_data_file,orbit_file,save,VAR,max_alt):
...
#Outputs:: Plots+ 1 csv file
    ...
    df = pd.read_csv("../DataFiles/OrbitData/"+orbit_file+".csv")
...
#             os.makedirs(directory)
        ...
        export_csv = df.to_csv (directory+orbit_file+"_" +VAR + '.csv', index = None, header=True)
